/* 8_2 лабораторная работа по ОАИП
Выполнена студентом группы МС-12 ГГУ
Тарасенко Давидом
Последняя правка 16.03.2023*/
...
int custom_menu(struct bank_client *ptr, unsigned *size_database, unsigned int *max_size_database)
{
    char char_of_command[3] = {};
    int number_of_command = 0;
    while(1)
